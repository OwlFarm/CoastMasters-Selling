...
export const makes = [
  ...
  { value: 'baglietto', label: 'Baglietto' },
  { value: 'bavaria', label: 'Bavaria' },
  { value: 'beneteau', label: 'Beneteau' },
  { value: 'benetti', label: 'Benetti' },
  { value: 'bertram', label: 'Bertram' },
  { value: 'blohm-voss', label: 'Blohm+Voss' },
  { value: 'burger', label: 'Burger' },
  { value: 'catalina', label: 'Catalina' },
  { value: 'chris-craft', label: 'Chris-Craft' },
  { value: 'christensen', label: 'Christensen' },
  { value: 'crn', label: 'CRN' },
  { value: 'delta-marine', label: 'Delta Marine' },
  { value: 'dufour', label: 'Dufour' },
  { value: 'fairline', label: 'Fairline' },
  { value: 'feadship', label: 'Feadship' },
  { value: 'ferretti', label: 'Ferretti' },
  { value: 'gulf-craft', label: 'Gulf Craft' },
  { value: 'hakvoort', label: 'Hakvoort' },
  { value: 'hanse', label: 'Hanse' },
  { value: 'hatteras', label: 'Hatteras' },
  { value: 'heesen', label: 'Heesen' },
  { value: 'hinckley', label: 'Hinckley' },
  { value: 'hunter', label: 'Hunter' },
  { value: 'isa-yachts', label: 'ISA Yachts' },
  { value: 'island-packet', label: 'Island Packet' },
  { value: 'jeanneau', label: 'Jeanneau' },
  { value: 'lagoon', label: 'Lagoon' },
  { value: 'leopard', label: 'Leopard' },
  { value: 'little-harbor', label: 'Little Harbor' },
  { value: 'lurssen', label: 'Lürssen' },
  { value: 'majesty', label: 'Majesty' },
  { value: 'mangusta', label: 'Mangusta' },
  { value: 'moody', label: 'Moody' },
  { value: 'nautor-swan', label: "Nautor's Swan" },
  { value: 'oceanco', label: 'Oceanco' },
  { value: 'overmarine', label: 'Overmarine' },
  { value: 'palmer-johnson', label: 'Palmer Johnson' },
  { value: 'perini-navi', label: 'Perini Navi' },
