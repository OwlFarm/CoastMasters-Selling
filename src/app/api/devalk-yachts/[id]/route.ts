...
// GET: Retrieve specific yacht by ID
export async function GET(
  ...
  try {
    ...
    console.log('🔍 Fetching yacht with ID:', id);
    
    const yacht = await prisma.deValkYacht.findUnique({
      where: { id },
    });
...
export async function PUT(
  ...
  try {
    ...
    const updatedYacht = await prisma.deValkYacht.update({
      where: { id },
      data: {
    ...
    console.log('✅ Yacht updated successfully:', updatedYacht.id);
...
// DELETE: Soft delete yacht (set isActive to false)
export async function DELETE(
  ...
  try {
    ...
    console.log('🗑️ Soft deleting yacht with ID:', id);
    
    const deletedYacht = await prisma.deValkYacht.update({
      where: { id },
      data: { isActive: false },
    });
    
    console.log('✅ Yacht soft deleted successfully:', deletedYacht.id);
