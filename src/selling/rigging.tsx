    ...
    <Card>
      ...
      <CardContent>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <FormField control={form.control} name="rigging.multifunctionalWinches" render={({ field }) => (<FormItem><FormLabel>Multifunctional Winches</FormLabel><FormControl><Input placeholder="e.g., Lewmar 8 Pole hoist winch" {...field} value={field.value ?? ''} /></FormControl><FormMessage /></FormItem>)} />
          <FormField control={form.control} name="rigging.spiPole" render={({ field }) => (<FormItem><FormLabel>Spi-Pole</FormLabel><FormControl><Input placeholder="e.g., aluminium" {...field} value={field.value ?? ''} /></FormControl><FormMessage /></FormMessage>)} />
        </div>
      </CardContent>
    </Card>
  );
