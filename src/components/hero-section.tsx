                ...
                >
                    ...
                    <div className="container relative mx-auto px-4 text-center text-white">
                        <div className="flex flex-col items-center justify-center pt-24 pb-16 md:pt-32 md:pb-16">
                            <h1 className="max-w-2xl font-headline text-4xl font-bold tracking-tight sm:text-5xl md:text-5xl">
                            ...
                            <div className="my-auto flex flex-col items-center justify-center gap-4 pt-16 sm:flex-row">
                                <CollapsibleTrigger asChild>
                                    <Button
                                        variant="default"
                                        size="lg"
                                        className="bg-accent px-10 text-xl text-accent-foreground hover:bg-accent/90"
                                    >
                                        Buy a Boat
                                    </Button>
                                </CollapsibleTrigger>
