...
const STEPS = [
  { id: 'Step 1', name: 'Details', fields: ['title', 'make', 'model', 'year', 'length', 'price', 'description'] as const },
  { id: 'Step 2', name: 'Photos', fields: ['heroImage', 'galleryImages'] as const },
];
                    ...
                    {currentStep === 1 && (
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>High-quality photos are crucial for attracting buyers.</CardDescription>
                            </CardHeader>
                 ...
                 <div className="flex justify-end">
                    <Button type="button" size="lg" onClick={next}>
                        {currentStep === STEPS.length - 1 ? (
                            <> <Eye className="mr-2" /> Preview Listing </>
                        ): 'Next Step'}
                    </Button>
                </div>
                </form>
