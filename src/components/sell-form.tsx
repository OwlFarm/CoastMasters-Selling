                                ...
                                <Card>
                                    ...
                                    <CardContent>
                                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                                            ...
                                            <FormField control={form.control} name="equipment.bathingPlatform" render={({ field }) => (<FormItem><FormLabel>Bathing Platform</FormLabel><FormControl><Input placeholder="e.g., Custom made stainless steel and teak" {...field} /></FormControl><FormMessage /></FormMessage>)} />
